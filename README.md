...
For a spectra comparison, please see the figure below. Generated by the same script [demos/test_pyseistr_das.py](https://github.com/aaspip/pyseistr/tree/main/demos/test_pyseistr_das.py)

<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/test_pyseistr_das_fx.png' alt='Slicing' width=960/>
...
<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/patches.png' alt='comp' width=960/>
</p>

# We now can highlight the slices in the plot3d function
Generated by [Example 6 in plot3d documentation](https://github.com/aaspip/pyseistr/blob/main/pyseistr/plot.py)

<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/pyseistr_plot3d_slices.jpg' alt='comp' width=960/>
</p>

# We now can show the inside of the 3D cube in the plot3d function
Generated by [Example 7 in plot3d documentation](https://github.com/aaspip/pyseistr/blob/main/pyseistr/plot.py)

<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/pyseistr_plot3d_inside.png' alt='comp' width=960/>
</p>

# We now can plot a 3D cube with surface topography
Generated by [Example 8 in plot3d documentation](https://github.com/aaspip/pyseistr/blob/main/pyseistr/plot.py)

<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/pyseistr_vel3d_topo_new.jpg' alt='comp' width=960/>
</p>

# We have a regularization function for putting data from XYZ format (ASCII) to a regularly sampled format
Generated by [Example 1 in xyz2rsf documentation](https://github.com/aaspip/pyseistr/blob/main/pyseistr/regularization.py)

<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/pyseistr_xyz2rsf.png' alt='comp' width=960/>
</p>

# We can also transform (or interpolate) a regularly sampled data from grid 1 to grid 2
Generated by [Example 1 in rsf3to3 documentation](https://github.com/aaspip/pyseistr/blob/main/pyseistr/regularization.py)

<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/pyseistr_rsf3to3_0.png' alt='comp' width=960/>
</p>
<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/pyseistr/pyseistr_rsf3to3_1.png' alt='comp' width=960/>
</p>
