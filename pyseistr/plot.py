...
def plot2d(d2d,z=None,x=None,dz=0.01,dx=0.01,figsize=(8, 6),ifnewfig=True,figname=None,showf=True,close=True,**kwargs):
	...
	EXAMPLE 6 (plot many velocity slices together for 3D and 2D)
...
def project_3d_to_figure(fig, ax, x, y, z):
    """Return (xf, yf) figure coordinates of a 3D point."""
    fig.canvas.draw()  # ensure projection is updated
...
def plot3d(d3d,frames=None,z=None,x=None,y=None,dz=0.01,dx=0.01,dy=0.01,nlevel=100,figsize=(8, 6),ifnewfig=True,figname=None,showf=True,close=True,ifslice=True,ifinside=False,topo=None,Vtopo=None,**kwargs):
	...
	EXAMPLE 9 (plot many velocity slices together for 3D and 2D)
	#DATA SOURCE: https://github.com/chenyk1990/txed
