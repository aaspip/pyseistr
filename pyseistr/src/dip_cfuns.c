...
static char dipcfun_document[] = "Document stuff for radon...";

// defining our functions like below:
// function_name, function, METH_VARARGS flag, function documents
static PyMethodDef functions[] = {
  {"radonc_inv", radonc_inv, METH_VARARGS, dipcfun_document},
  {"radonc_fb", radonc_fb, METH_VARARGS, dipcfun_document},
